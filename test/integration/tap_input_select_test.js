suite('MarionetteHelper.fillInputFieldAndselectSelectOption', function() {
  ...
  test('should set on option', function() {
    ...
    helper.selectSelectOption('#select', optionValue);
...
/*
  test('should set value on input', function() {
    ...
    assert.ok(fakeApp.isInputElementValueSet('', inputValue));
  });
*/
  test('should set date on input', function() {
    ...
    assert.ok(fakeApp.isInputElementValueSet('date', inputValue));
  });
  ...
  test('should set time on input', function() {
    ...
    assert.ok(fakeApp.isInputElementValueSet('time', inputValue));
  });
  ...
  test('should set datetime on input', function() {
    var inputValue = testTime.getFullYear() + '-' +
                     ...
                     addLeadZero(testTime.getMinutes()) + ':' +
                     addLeadZero(testTime.getSeconds()) + 'Z';

    helper.fillInputField('#input-datetime', testTime);
    assert.ok(fakeApp.isInputElementValueSet('datetime', inputValue));
  });
});
